...
import { products, categories, type Category, type Size } from "@/data/products";
...
const Products = () => {
  ...
  const filtered = useMemo(() => {
    ...
    return result;
  }, [selectedCategory, selectedSize, priceRange, filterParam]);
        ...
        <div className="container py-8 md:py-12">
          <div className="flex items-center justify-between mb-8">
            ...
            <button
              ...
              className="md:hidden flex items-center gap-2 text-sm font-medium border border-border px-4 py-2"
            >
            ...
            <aside className={`${filtersOpen ? "fixed inset-0 z-40 bg-background p-6 overflow-auto" : "hidden"} md:block md:static md:w-56 shrink-0`}>
              ...
              <div className="space-y-8">
                  ...
                  <div className="space-y-2">
                    ...
                    {categories.map((c) => (
                      <button
                        ...
                        className={`block text-sm transition-colors ${selectedCategory === c.slug ? "text-foreground font-medium" : "text-muted-foreground hover:text-foreground"}`}
                      >
                        {c.name}
                      </button>
                    ))}
                ...
                <div>
                  ...
                  <div className="flex gap-2 items-center text-sm">
                    <input
                      ...
                      className="w-20 border border-border px-2 py-1.5 bg-background text-sm"
                      min={0}
                    />
                ...
                <button
                  ...
                  className="md:hidden w-full bg-foreground text-background py-3 font-display font-semibold text-sm tracking-wide mt-4"
                >
            ...
            <div className="flex-1">
              {filtered.length === 0 ? (
                <div className="text-center py-20">
                  ...
                  <button onClick={clearFilters} className="text-accent hover:underline text-sm mt-2">
                    Clear filters
                  </button>
                </div>
              ) : (
