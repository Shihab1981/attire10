      ...
      <main className="flex-1">
        ...
        <div className="border-b border-border/60">
          <div className="container py-4">
            <Link
              to="/products"
              className="inline-flex items-center gap-2 text-[11px] font-body font-medium tracking-[0.1em] uppercase text-muted-foreground hover:text-foreground transition-colors"
            >
          ...
          <div className="grid md:grid-cols-2 gap-8 md:gap-20">
            ...
            >
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-3 bg-foreground text-background py-4.5 text-[11px] font-body font-semibold tracking-[0.2em] uppercase hover:bg-accent hover:text-accent-foreground transition-all duration-300 mt-auto"
              >
