            ...
            <div className="grid lg:grid-cols-3 gap-8 md:gap-12">
                ...
                {items.map((item) => (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      <Link to={`/product/${item.product.id}`} className="font-display font-medium text-sm hover:underline line-clamp-1">
                        {item.product.name}
                      </Link>
                      <p className="text-xs text-muted-foreground mt-1">
                        Size: {item.size}
                      </p>
                      <p className="font-display font-semibold text-sm mt-2">
              ...
              <div className="lg:col-span-1">
                <div className="bg-secondary/50 p-6 sticky top-24">
                  ...
                  <Link
                    to="/checkout"
                    className="block w-full text-center mt-6 bg-foreground text-background py-3.5 font-display font-semibold text-sm tracking-wide hover:bg-accent hover:text-accent-foreground transition-colors"
                  >
                    Proceed to Checkout
                  </Link>
                  <Link
