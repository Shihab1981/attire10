  ...
  <div className="bg-secondary/40 rounded-md p-4 mt-3 border border-border/40">
    <div className="bg-background rounded-md shadow-sm p-3 max-w-[240px] mx-auto border border-border/40">
      <div className="flex items-center gap-2 mb-2">
        ...
        <div>
          <div className="text-[9px] font-semibold">Install DEVICE HUB?</div>
  ...
  <div className="bg-secondary/40 rounded-md p-4 mt-3 border border-border/40">
    <div className="bg-background rounded-md shadow-sm p-3 max-w-[240px] mx-auto">
      <div className="flex items-center justify-center gap-2 py-3">
        ...
        <div className="text-[10px] font-display font-bold">DEVICE HUB</div>
      </div>
...
const Install = () => {
  ...
  useEffect(() => {
    ...
    const installedHandler = () => {
      ...
      toast.success("DEVICE HUB installed successfully!");
    };
  ...
  const handleInstall = async () => {
    ...
    if (outcome === "accepted") toast.success("Installing DEVICE HUB...");
    setDeferredPrompt(null);
  };
      ...
      <main className="flex-1">
        ...
        <section className="container py-12 md:py-20 text-center">
          ...
          <p className="text-muted-foreground max-w-xl mx-auto text-sm md:text-base leading-relaxed mb-8">
            Get the full DEVICE HUB experience on your device. Faster, smoother, and works even when you're offline.
          </p>
              ...
              {platform === "android" && (
                <Steps
                  ...
                  steps={[
                    ...
                    {
                      text: "Tap 'Install' to confirm — DEVICE HUB will appear on your home screen",
              ...
              {platform === "desktop" && (
                <Steps
                  ...
                  steps={[
                    ...
                    {
                      text: "DEVICE HUB will open in its own window — pin it to your taskbar or dock",
